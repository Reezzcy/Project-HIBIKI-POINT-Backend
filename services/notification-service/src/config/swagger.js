...
const options = {
    definition: {
        openapi: '3.0.0',
        info: {
            title: 'Notification Service API', // Judul spesifik untuk service ini
            version: '1.0.0',
            description:
                'API documentation for the Notification Service, which handles notifications and alerts for the application.',
        },
